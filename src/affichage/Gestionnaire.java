...
public class Gestionnaire extends TypeUtilisateur {
	...
	private Commande choixCommandeAMaj() {
		...
		commandes.add(new Commande(General.getDateNow().toString(), "Domicile", "Prï¿½te ï¿½ l'envoi", 51478, (float) 10));
		commandes.add(new Commande(General.getDateNow().toString(), "En retrait", "Prï¿½te ï¿½ l'envoi", 69854, (float) 10));

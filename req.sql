...
CREATE  SEQUENCE ARTICLES_SEQ
 ...
 DROP SEQUENCE COMMANDES_SEQ;
CREATE  SEQUENCE COMMANDES_SEQ
 START WITH     0
 INCREMENT BY   1
 MINVALUE 0
 NOCACHE
...
(
   ...
   CONSTRAINT FK_FICHIERIMAGE 
      FOREIGN KEY (PROPRIETAIRE) REFERENCES CLIENT(MAILCLIENT) ON DELETE CASCADE,
...
(
   ...
   CONSTRAINT FK_CODEPROMOCLIENT_1
      FOREIGN KEY (CODE) REFERENCES CODEPROMO(CODE) ON DELETE CASCADE,
...
(
   ...
   CONSTRAINT FK_PHOTO
      FOREIGN KEY (PATH,PROPRIETAIRE) REFERENCES FICHIERIMAGE(PATH,PROPRIETAIRE) ON DELETE CASCADE
);
...
(
   ...
   CONSTRAINT FK_ARTICLE_2
      FOREIGN KEY (NUMIMPRESSION) REFERENCES IMPRESSION(NUMIMPRESSION) ON DELETE CASCADE
);
...
(
   ...
   CONSTRAINT FK_BUREAU
      FOREIGN KEY (NUMIMPRESSION) REFERENCES CALENDRIER(NUMIMPRESSION) ON DELETE CASCADE
);
...
(
   ...
   CONSTRAINT FK_PHOTOCADRE_1
      FOREIGN KEY (NUMIMPRESSION) REFERENCES CADRE(NUMIMPRESSION) ON DELETE CASCADE,
   CONSTRAINT FK_PHOTOCADRE_2s
...
(
   ...
   CONSTRAINT FK_JOURS
      FOREIGN KEY (NUMIMPRESSION) REFERENCES AGENDA(NUMIMPRESSION) ON DELETE CASCADE
);
...
(
   NUMIMPRESSION         NUMBER                         NOT NULL,
   ID_PHOTO              NUMBER                         NOT NULL,
   NOPAGEPHOTOALBUM      NUMBER                         NOT NULL,
   CONSTRAINT PK_PHOTOALBUM_13 PRIMARY KEY (NUMIMPRESSION, ID_PHOTO, NOPAGEPHOTOALBUM),
   CONSTRAINT FK_PHOTOALBUM_1
      FOREIGN KEY (NUMIMPRESSION) REFERENCES ALBUM(NUMIMPRESSION) ON DELETE CASCADE,
...
(
   NUMIMPRESSION         NUMBER                        NOT NULL,
   ID_PHOTO             NUMBER                         NOT NULL,
   NOPAGEPHOTOAGENDA    NUMBER                         NOT NULL,
...
(
   NUMIMPRESSION         NUMBER                         NOT NULL,
   ID_PHOTO              NUMBER                         NOT NULL,
   NBEXEMPLAIRE          NUMBER                         NOT NULL,
   CONSTRAINT PK_PHOTOTIRAGE PRIMARY KEY (NUMIMPRESSION, ID_PHOTO),
   CONSTRAINT FK_PHOTOTIRAGE_1
      FOREIGN KEY (NUMIMPRESSION) REFERENCES TIRAGE(NUMIMPRESSION) ON DELETE CASCADE ,
...
(
   NUMIMPRESSION         NUMBER                         NOT NULL,
   ID_PHOTO              NUMBER                         NOT NULL,
   NOPAGEPHOTOCALENDRIER NUMBER                         NOT NULL,
...
INSERT INTO COMMANDE VALUES ('2019-01-20', 'ADRESSE', 'EN COURS', COMMANDES_SEQ.NEXTVAL,  NULL ,'LREOOF@ORANGE.FR', 50 );
INSERT INTO COMMANDE VALUES ('2019-01-15', 'ADRESSE', 'EN COURS', COMMANDES_SEQ.NEXTVAL, 'AKJSDFSSD4F51Z545D564S5Z64S64','WILLY@ORANGE.FR', 25 );
INSERT INTO COMMANDE VALUES ('2019-01-01', 'ADRESSE', 'EN COURS', COMMANDES_SEQ.NEXTVAL, 'S5FSF6SDF545D564S5Z64S64','WILLY@ORANGE.FR', 52);
INSERT INTO COMMANDE VALUES ('2019-01-12', 'ADRESSE', 'EN COURS', COMMANDES_SEQ.NEXTVAL, 'SQ5D4SD1FDFZ545D564S5Z64S64','JEAP@GMAIL.COM', 26);
INSERT INTO COMMANDE VALUES ('2019-01-12', 'ADRESSE', 'EN COURS', COMMANDES_SEQ.NEXTVAL, NULL,'JEAP@GMAIL.COM', 45);
...
/
*/
/*** test MUTATING TRIGGER (GÉRÉ DANS L'APPLICATION )***/
/*
...
/*** TEST ok ***/
/*
INSERT INTO CLIENT VALUES ('EXEMPLE@TEST.FR', 'SERGE', 'BENAMOU', 'SDF545', 1);
INSERT INTO CODEPROMO VALUES ('NBJBDJ4564', 25, 'GENERAL');
INSERT INTO CODEPROMOCLIENT VALUES ('NBJBDJ4564', 'EXEMPLE@TEST.FR', 1);
INSERT INTO COMMANDE VALUES ('2019-01-20', 'ADRESSE', 'EN COURS', 1024, 'NBJBDJ4564' ,'EXEMPLE@TEST.FR', 50 );
*/
...
/*
INSERT INTO CLIENT VALUES ('EXEMPLE@TEST.FR', 'SERGE', 'BENAMOU', 'SDF545', 1);
INSERT INTO CODEPROMO VALUES ('NBJBDJ4564', 25, 'PERSONNEL');
INSERT INTO CODEPROMOCLIENT VALUES ('NBJBDJ4564', 'EXEMPLE@TEST.FR', 1);
INSERT INTO COMMANDE VALUES ('2019-01-20', 'ADRESSE', 'EN COURS', 1024, 'NBJBDJ4564' ,'EXEMPLE@TEST.FR', 50 );
*/
...
/
*/
SELECT S.QUANTITESTOCK FROM STOCK S NATURAL JOIN STOCKARTICLE SA
   NATURAL JOIN ARTICLE A
   WHERE ID_ARTICLE = 1;

SELECT TYPE_IMPRESSION, QUALITE, FORMAT FROM STOCKARTICLE WHERE ID_ARTICLE =

/*   USING (TYPE_IMPRESSION, QUALITE, FORMAT) USING (ID_ARTICLE)
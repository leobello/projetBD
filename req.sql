...
(
   ...
   CONSTRAINT CK_CODEPROMO
      CHECK (TYPE='GENERAL' OR TYPE='PERSONNEL')
);
...
INSERT INTO CODEPROMO VALUES ('AKJFKJDDFDFZ545D564S5Z64S64',1, 12.5, 'GENERAL');
INSERT INTO CODEPROMO VALUES ('AKJFKJJDHFJHKJSF545666SDF',2, 5.3, 'PERSONNEL');
INSERT INTO CODEPROMO VALUES ('AKJSDFSSD4F51Z545D564S5Z64S64',3, 10, 'PERSONNEL');
INSERT INTO CODEPROMO VALUES ('SDFS51DFS1DF45D564S5Z64S64',4, 15.2, 'PERSONNEL');
INSERT INTO CODEPROMO VALUES ('SQ5D4SD1FDFZ545D564S5Z64S64',5, 13.2, 'GENERAL');
INSERT INTO CODEPROMO VALUES ('S5FSF6SDF545D564S5Z64S64',6, 25, 'GENERAL');
...
-- si Codepromo pas dans code promo client est code promo générale sauf si ultilisé
CREATE TABLE CODEPROMO 
(
   CODE                 VARCHAR(255)                   NOT NULL,
   ID_CODEPROMO         NUMBER                         NOT NULL,
